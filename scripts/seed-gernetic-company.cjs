/**
 * 제네틱상사 브랜드사 계정 시드 — 구조 복제 전용 (볼라욘 패턴)
 ...
 * 실행: node scripts/seed-gernetic-company.cjs
 */
...
const COMPANY_NAME = '제네틱상사'
const EMAIL = 'gernetic@auran.kr'
const PASSWORD = 'gernetic1234'
const HUB_SLUG = 'gernetic'
const LOGIN_ROLE = 'ceo'
const CEO_USERNAME = 'gerneticceo'
const CEO_PIN = '1234'
const CEO_NAME = '제네틱 대표'
const BRAND_NAME = '제네틱상사'
const BRAND_NAME_KR = '제네틱상사'
...
async function main() {
  ...
  // 6) verify: NO tier / arete rows for this company
  {
  ...
  console.log('\nDONE')
  console.log('  Hub login: /brand/' + HUB_SLUG + '  (id: gernetic / pw: ' + PASSWORD + ')')
