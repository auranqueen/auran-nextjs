/**
 * SH코스메틱그룹 브랜드사 계정 시드 — 구조 복제 전용 (gernetic/annarosa 패턴)
 ...
 * 실행: node scripts/seed-shcosmetics-company.cjs
 */
...
const COMPANY_NAME = 'SH코스메틱그룹'
const EMAIL = 'shcosmetics@auran.kr'
const PASSWORD = 'shcosmetics1234'
const HUB_SLUG = 'shcosmetics'
const LOGIN_ROLE = 'ceo'
const CEO_USERNAME = 'shcosmeticsceo'
const CEO_PIN = '1234'
const CEO_NAME = 'SH코스메틱 대표'
const BRAND_NAME = 'SH코스메틱그룹'
const BRAND_NAME_KR = 'SH코스메틱그룹'
...
async function main() {
  ...
  console.log('\nDONE')
  console.log('  Hub login: /brand/' + HUB_SLUG + '  (id: shcosmetics / pw: ' + PASSWORD + ')')
