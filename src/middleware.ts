...
export async function middleware(req: NextRequest) {
  ...
  if (pathname.startsWith('/dashboard/customer/chat') || pathname.startsWith('/dashboard/owner/chat') || (pathname.startsWith('/dashboard/owner') && req.headers.get('referer')?.includes('/admin'))) return NextResponse.next()
