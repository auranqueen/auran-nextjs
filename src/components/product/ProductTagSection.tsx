...
const getHormoneMatchMsg = (
  ...
  if (hasAll) return {
    match: true,
    title: '언제 써도 좋은 제품이에요 💜',
    sub: '모든 호르몬 단계에 잘 맞아요',
  }

  if (customerPhase === '갱년기') return {
    match: true,
    title: '갱년기 피부에 잘 맞는 제품이에요 🌿',
    sub: '꾸준히 쓸수록 피부가 달라져요',
  }
  ...
  if (isMatch) {
    const matchMsgs: Record<string, { title: string; sub: string }> = {
      달빛기: {
        title: '달빛기인 지금 쓰면 드라마틱해요 🌙',
        sub: '자극 없는 순한 성분이 예민한 피부를 가장 잘 달래줘요',
      },
      황금기: {
        title: '황금기인 지금 쓰면 드라마틱해요 ✨',
        sub: '흡수력 최고인 지금 효과가 극대화돼요!',
      },
      만개기: {
        title: '만개기인 지금 쓰면 드라마틱해요 🌸',
        sub: '피부가 가장 빛나는 지금 이 제품으로 광채 극대화해요!',
      },
      물들기: {
        title: '물들기인 지금 쓰면 드라마틱해요 🍂',
        sub: '붓기·예민함 잡는데 지금이 딱이에요',
      },
    }
    return {
      match: true,
      ...(matchMsgs[customerPhase] || {
        title: '지금 쓰면 드라마틱해요 💜',
        sub: '내 피부 단계에 잘 맞아요',
      }),
    }
  ...
  const mismatchMsgs: Record<string, Record<string, { title: string; sub: string }>> = {
    달빛기: {
      황금기: {
        title: '지금 담아두세요! 황금기(6~13일차)에 드라마틱해요 ✨',
        sub: '생리 끝나고 바로 쓰면 흡수력이 극대화돼요',
      },
      만개기: {
        title: '지금 담아두세요! 만개기(14~16일차)에 드라마틱해요 🌸',
        sub: '배란기 피부 최고조일 때 효과가 2배예요',
      },
      물들기: {
        title: '지금 담아두세요! 물들기(17~28일차)에 드라마틱해요 🍂',
        sub: '붓기·예민함 올라올 때 쓰면 딱이에요',
      },
    },
    황금기: {
      달빛기: {
        title: '달빛기(1~5일차)에 더 드라마틱한 제품이에요 🌙',
        sub: '지금 담아두고 다음 생리 때 써보세요',
      },
      만개기: {
        title: '지금도 좋고 만개기(14~16일차)엔 더 드라마틱해요 🌸',
        sub: '배란기 피부 광채 극대화에 좋아요',
      },
      물들기: {
        title: '물들기(17~28일차)에 쓰면 더 드라마틱해요 🍂',
        sub: '황체기 붓기·예민함 케어에 딱이에요',
      },
    },
    만개기: {
      달빛기: {
      ...
      황금기: {
        title: '지금도 좋고 황금기(6~13일차)엔 더 드라마틱해요 ✨',
        sub: '지금 써도 좋고 황금기에 쓰면 더 좋아요',
      },
      물들기: {
        title: '물들기(17~28일차)에 쓰면 더 드라마틱해요 🍂',
        sub: '배란 후 붓기·예민함 케어에 도움돼요',
      },
    },
    물들기: {
      달빛기: {
      ...
      황금기: {
        title: '다음 황금기(6~13일차)에 쓰면 드라마틱해요 ✨',
        sub: '피부 흡수력 최고인 시기에 효과가 극대화돼요',
      },
      만개기: {
        title: '다음 만개기(14~16일차)에 쓰면 드라마틱해요 🌸',
        sub: '배란기 피부 최고조일 때 빛이 나요',
      },
    },
  }
  ...
  if (customerMsgs) {
    ...
    const msg = firstProductTag
      ...
      : null
    if (msg) return { match: true, ...msg }
  }

  return {
    match: true,
    title: '지금 담아두세요! 최적 시기에 드라마틱해요 💜',
    sub: '내 피부 사이클에 맞춰 쓰면 효과가 극대화돼요',
  }
}
