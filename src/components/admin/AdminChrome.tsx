...
const MENU = [
  { section: 'OVERVIEW', items: [{ label: '통합 현황', href: '/admin', icon: '📊' }, { label: '실시간 모니터', href: '/admin/live', icon: '📡' }] },
  {
    ...
    items: [
      ...
      { label: '토스트 내역', href: '/admin/toast-history', icon: '🍞' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: '채팅 배너 관리', href: '/admin/chat-banner', icon: '📢' },
...
const pageTitleByPath = (path: string) => {
  ...
  if (path.startsWith('/admin/products/edit')) return '제품 등록'
  ...
  if (path.startsWith('/admin/chat-banner')) return '채팅 배너 관리'
                    ...
                    return (
                      <Link
                        ...
                        style={{
                          ...
                          marginBottom: 3,
                          color: 'color' in it ? it.color : 'var(--text)',
                        }}
                      >
