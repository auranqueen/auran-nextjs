    ...
    <div style={{ marginTop: 10, border: `1px solid ${CARD_BORDER}`, borderRadius: 12, background: CARD_BG, padding: 12, position: 'relative' }}>
      ...
      {!editing ? (
        ...
        <div style={{ display: 'grid', gap: 8 }}>
          ...
          <textarea value={draft.quote} onChange={(e) => setDraft((d) => ({ ...d, quote: e.target.value }))} placeholder="오렌 한마디" rows={2} style={{ width: '100%', boxSizing: 'border-box', background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.12)', borderRadius: 8, color: '#fff', fontSize: 12, fontWeight: 400, padding: '9px 10px' }} />
