    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: '8px' }}>
          {[
            { icon: '�??�', val: '6', unit: '/8', label: '�??�? �?�취', pct: 75, color: '#6ab0e0' },
            { icon: '�???', val: 'UV', unit: '3', label: '�?��?��?�', pct: 40, color: '#f0c040' },
            { icon: '�??�', val: '7.5', unit: 'h', label: '�??면', pct: 80, color: '#a080e0' },
            { icon: '�?��', val: '75', unit: '%', label: '루�?�', pct: 75, color: GOLD },
          ].map((item, i) => (
            <div key={i} style={{
      ...
      <div style={{ margin: '14px 16px 0', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
        {[
          { icon: '�??�', title: '�?��?�?�?�', desc: 'AI �?�? �?�?�', badge: 'AI', path: '/skin-analysis', bg: 'linear-gradient(135deg,rgba(160,80,220,0.15),rgba(120,60,180,0.1))' },
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          ...
          <div>
            ...
            {/* TODO: user_wallets �??이�?�?��?? 포인�?� 조�?? */}
            <div style={{ fontSize: '14px', fontWeight: 400 }}>
              <em style={{ color: GOLD, fontStyle: 'normal' }}>8,888P</em>{' '}
              <span style={{ color: TEXT_MUTED, fontSize: '11px' }}>보�?��?</span>
            </div>
          </div>
        </div>
