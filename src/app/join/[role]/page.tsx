...
export default async function JoinPage({ params, searchParams }: Props) {
  ...
  const ROLE_META: Record<string, any> = {
    ...
    partner:  { label: '파트너스', icon: '💼', color: '#4a8dc0', desc: '추천 링크 공유 → 커미션 수익', benefit: '💰 가입 즉시 추천 링크 생성' },
    owner:    { label: '원장님', icon: '🏥', color: '#bf5f90', desc: '예약 관리 + 스토어 + 매출', benefit: '⭐ BASIC 스토어 무료 시작' },
    brand:    { label: '브랜드사', icon: '🏭', color: '#4cad7e', desc: 'AI 추천 노출 + 전국 살롱 납품', benefit: '✅ 입점 신청 즉시 검토' },
  }
