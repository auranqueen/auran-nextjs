...
export default function OwnerSalesReportComingSoonPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: BG, color: TEXT }}>
      <div style={{ display: 'flex', alignItems: 'center', padding: '14px 16px', borderBottom: `0.5px solid ${BORDER}` }}>
        ...
        <div style={{ flex: 1, textAlign: 'center', fontSize: 16, fontWeight: 500 }}>매출 리포트</div>
        <div style={{ width: 28 }} />
      </div>
      ...
      >
        ...
        <div style={{ fontSize: 13, color: TEXT_SUB, lineHeight: 1.7, maxWidth: 320, marginBottom: 24 }}>
          일별·월별 매출 추이를 한눈에 볼 수 있는 리포트를 준비하고 있어요
        </div>
        <div
          style={{
            fontSize: 11,
