        ...
        <div style={{ marginTop: 12 }}>
          ...
          {draft.tiers.map((tier, idx) => (
            <div key={idx} style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 8, padding: 12, marginBottom: 8 }}>
              ...
              <label style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 13, marginBottom: 6, color: '#4A2C7A' }}>
              ...
              <input
                ...
                style={{ width: '100%', fontSize: 12, color: '#4A2C7A', background: 'rgba(123,94,167,0.08)', border: '1px solid rgba(123,94,167,0.3)' }}
              />
            </div>
          ))}
