...
export default function BrandOrdersSummary({ brandId }: Props) {
  ...
  const fetchData = useCallback(async () => {
    ...
    setOrders((recentOrders || []) as RecentOrderRow[])
    setThisMonthOrders((thisMonthOrdersData || []) as Array<{ id: string; status: string; items: Array<{ name: string; qty: number }> }>)
    setLoading(false)
  }, [brandId])
