...
const META: Record<string, { label: string; keys: Record<string, SettingMeta> }> = {
  points_action: {
    ...
    keys: {
      ...
      get_follower: { label: '오렌일촌 생길 때 포인트', unit: 'P', type: 'number', defaultValue: '30' },
  ...
  star_level: {
    ...
    keys: {
      ...
      lv2_followers: { label: '글로우 등급 오렌일촌 수', unit: '명', type: 'number', defaultValue: '10' },
      lv3_journals: { label: '뷰티스타 저널 수', unit: '개', type: 'number', defaultValue: '20' },
      lv3_followers: { label: '뷰티스타 오렌일촌 수', unit: '명', type: 'number', defaultValue: '50' },
      ...
      lv4_followers: { label: '인플루언서 오렌일촌 수', unit: '명', type: 'number', defaultValue: '200' },
      lv4_likes: { label: '인플루언서 공감 수', unit: '개', type: 'number', defaultValue: '500' },
      lv5_followers: { label: 'AURAN퀸 오렌일촌 수', unit: '명', type: 'number', defaultValue: '500' },
  ...
  copy_social: {
    label: '소셜 문구',
    keys: {
      follow_btn: { label: '오렌일촌 맺기 버튼', unit: '', type: 'text', defaultValue: '오렌일촌 맺기' },
      following_btn: { label: '오렌일촌 상태 버튼', unit: '', type: 'text', defaultValue: '오렌일촌 ✓' },
      unfollow_btn: { label: '오렌일촌 끊기 버튼', unit: '', type: 'text', defaultValue: '오렌일촌 끊기' },
      follower_label: { label: '오렌일촌 라벨', unit: '', type: 'text', defaultValue: '오렌일촌' },
      following_label: { label: '내 오렌일촌 라벨', unit: '', type: 'text', defaultValue: '내 오렌일촌' },
      notify_text: { label: '오렌일촌 신청 알림 문구', unit: '', type: 'text', defaultValue: '님이 오렌일촌을 신청했어요 🤝' },
      new_follower_text: { label: '새 오렌일촌 알림 문구', unit: '', type: 'text', defaultValue: '새 오렌일촌이 생겼어요!' },
    },
  },
  toast: {
    label: '토스트',
