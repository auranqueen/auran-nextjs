...
- 데오도란트·방취·체취·땀억제 성분 포함 → situation_tags에 체취케어 추가
- 체취케어 제품 age_tag: 전연령 (10대 사춘기부터 50대이상까지 모두 해당)
- 남성 체취/데오도란트 → gender_tag '남성' or '공용', age_tag '10대','20대','30대','40대','50대이상'
- 여성 갱년기 + 체취 관련 → age_tag '50대이상', gender_tag '공용'
- 청소년 여드름·체취 복합 제품 → age_tag '10대', situation_tags에 10대사춘기·체취케어 둘 다 추가
- 특정 연령 타겟 없으면 '전연령' 추가`
