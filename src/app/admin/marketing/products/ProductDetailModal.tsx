...
- 데오도란트·체취케어·방취·땀억제 성분 포함 → situation_tags에 체취케어 추가, age_tag '40대','50대이상' 추가
- 여성 갱년기 성분(이소플라본 등) + 체취 관련 → age_tag '50대이상', gender_tag '공용'
- 남성 체취/데오도란트 제품 → age_tag '20대','30대','40대','50대이상', gender_tag '남성' or '공용'
- 특정 연령 타겟 없으면 '전연령' 추가`
