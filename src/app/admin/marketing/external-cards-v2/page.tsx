...
<div class="join"><div style="display:flex;gap:10px;align-items:flex-start;"><div style="flex:1;"><div style="font-size:11px;font-weight:600;color:#fff;margin-bottom:4px;">생리 10일 전, 피부가 가장 뒤집힐 확률 87%</div><div style="font-size:8px;color:rgba(255,255,255,0.8);margin-bottom:6px;">같은 제품도 호르몬 주기에 따라 효과가 완전히 달라져요.</div><div style="display:grid;grid-template-columns:repeat(4,1fr);gap:3px;margin-bottom:6px;"><div style="background:rgba(255,255,255,0.12);border-radius:4px;padding:4px 5px;text-align:center;"><div style="font-size:7px;color:#C9A96E;">달빛기</div><div style="font-size:7px;color:rgba(255,255,255,0.7);">생리중~직후</div><div style="font-size:8px;color:#fff;margin-top:2px;">진정</div></div><div style="background:rgba(255,255,255,0.12);border-radius:4px;padding:4px 5px;text-align:center;"><div style="font-size:7px;color:#C9A96E;">황금기</div><div style="font-size:7px;color:rgba(255,255,255,0.7);">생리후 7~10일</div><div style="font-size:8px;color:#fff;margin-top:2px;">영양·미백</div></div><div style="background:rgba(255,255,255,0.12);border-radius:4px;padding:4px 5px;text-align:center;"><div style="font-size:7px;color:#C9A96E;">만개기</div><div style="font-size:7px;color:rgba(255,255,255,0.7);">배란기</div><div style="font-size:8px;color:#fff;margin-top:2px;">모공·유분</div></div><div style="background:rgba(255,255,255,0.12);border-radius:4px;padding:4px 5px;text-align:center;"><div style="font-size:7px;color:#C9A96E;">물들기</div><div style="font-size:7px;color:rgba(255,255,255,0.7);">생리전 7~10일</div><div style="font-size:8px;color:#fff;margin-top:2px;">트러블예방</div></div></div><div style="font-size:8px;color:rgba(255,255,255,0.85);line-height:1.6;">AURAN이 내 호르몬 주기를 읽고 오늘 필요한 홈케어를 알려드려요. 💜</div><div style="margin-top:5px;"><div style="font-size:8px;color:#C9A96E;">• 가입 즉시 10,000T 지급</div><div style="font-size:8px;color:rgba(255,255,255,0.8);">• 내 호르몬 주기 분석 · 맞춤 홈케어 루틴 제공</div></div></div><div style="text-align:center;flex-shrink:0;"><img src="${qrJoin}" width="52" height="52" style="display:block;border-radius:4px;background:#fff;padding:2px;" /><div style="font-size:7px;color:rgba(255,255,255,0.7);margin-top:2px;">카카오 가입</div></div></div></div>
